...
<div id="content">
	...
	<table id="tabel-input">
		<tr>
			<td class="label-formulir" hidden>ID Transaksi</td>
			<td class="isian-formulir"><input type="text" name="id_transaksi" class="isian-formulir isian-formulir-border" readonly hidden></td>
		</tr>
		<tr>
			<td class="label-formulir">Anggota</td>
			<td class="isian-formulir">
				<select name="id_anggota" class=" form-select isian-formulir isian-formulir-border" required>
		...
		<tr>
			...
			<td class="isian-formulir">
				<select name="id_buku" class="form-select isian-formulir isian-formulir-border" required>
		...
		<tr>
			...
			<td class="isian-formulir"><input type="text" class="form-control" name="tgl_pinjam" value="<?php echo $tgl; ?>" readonly="readonly" class="isian-formulir isian-formulir-border warna-formulir-disabled" required></td>
		</tr>
		<tr>
			<td class="label-formulir"></td>
			<td class="isian-formulir"><input type="submit" name="simpan" value="Simpan" class="tombol btn btn-primary"></td>
		</tr>
	</table>
	</form>
</div>