...
<div id="content">
	...
	<table class="table table-bordered" id="tabel-tampil">
		...
		<tr>
			...
			<td>
				<div class="tombol-opsi-container"><a class="btn btn-primary" href="cetak/nota-peminjaman.php?&id=<?php echo $r_transaksi['idtransaksi'];?>" target="_blank" class="tombol">Cetak Nota</a></div>
				<br>
				<div class="tombol-opsi-container"><a class="btn btn-info" href="proses/pengembalian-proses.php?&id=<?php echo $r_transaksi['idtransaksi'];?>" class="tombol">Pengembalian</a></div>
			</td>
		</tr>
		<?php } ?>
	</table>
